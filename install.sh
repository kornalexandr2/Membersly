...
echo "Access the Web UI at: http://<YOUR_SERVER_IP>:6116"
echo "Access the API at: http://<YOUR_SERVER_IP>:8000"
echo ""
...
echo "For production, please set up a Reverse Proxy (like Nginx Proxy Manager) to point to port 6116."
echo "-----------------------------"
