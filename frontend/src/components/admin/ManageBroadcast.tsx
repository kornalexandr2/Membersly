...
export const ManageBroadcast = ({ onAction }: any) => {
    ...
    const send = async () => {
        ...
        setMsg('');
        setStatus('Broadcast cycle complete.');
    };
    ...
    return (
        <div className="bg-neutral-900 p-10 rounded-[3rem] border border-white/10 max-w-2xl mx-auto space-y-8 shadow-2xl animate-in zoom-in-95 duration-500">
            <div className="text-center space-y-2">
                <h3 className="text-2xl font-black uppercase text-white tracking-tight italic">Neural <span className="text-blue-600">Broadcast</span></h3>
                <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-[0.2em]">Select Target Segment</p>
            </div>
